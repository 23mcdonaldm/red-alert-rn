...
const TypingText = memo(
    ({ text, styles }: { text: string; styles: any }) => {
      const safeText = text || "Error: No message content";
      ...
      return <Text style={styles}>{typedText}</Text>;
    },
...
const TypedProfileCard: React.FC<ProfileCardProps> = ({
  profilePhoto,
  name,
  xp,
  mainRole,
        ...
        >
          ...
          <View style={styles.profileHeader}>
            ...
            <View style={styles.profileInfo}>
              <TypingText text={name} styles={[styles.profileName, { color: theme.text }]} />
              <TypingText text={mainRole} styles={[styles.mainRole, { color: theme.textSecondary }]} />
              <TypingText text={"XP: " + xp} styles={[styles.mainRole, { color: theme.textTertiary }]} />
              
            </View>
          </View>

          {/* Left-aligned Description */}
          <TypingText text={description} styles={[styles.profileDescription, { color: theme.text }]} />
...
export default TypedProfileCard;
